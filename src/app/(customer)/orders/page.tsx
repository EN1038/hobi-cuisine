  ...
  if (loading) {
    return (
      <div className="min-h-screen pb-24 bg-[#f6e5cc] pt-20 px-4">
        <div className="h-8 w-40 bg-white/60 rounded-lg animate-pulse mb-2" />
        <div className="h-4 w-56 bg-white/40 rounded animate-pulse mb-6" />
        <div className="flex gap-2 mb-6">
          {[...Array(3)].map((_, i) => <div key={i} className="h-9 w-20 bg-white/60 rounded-lg animate-pulse" />)}
        </div>
